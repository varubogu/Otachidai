# Command Reference (Server Users)

For admin commands, see [Server Admins: Command Reference](../server-admins/command-reference.md).

---

## `/rent`

Starts a rental request.
...
| Item | Details |
|---|---|
| Permission | Everyone (admins see additional info) |
| Arguments | None |
